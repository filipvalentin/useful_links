...
- CQRS (and some Event Sourcing)
  ...
  - Udi Dahan, 'Why you should be using CQRS almost everywhere…'. Oct. 2nd, 2011. https://udidahan.com/2011/10/02/why-you-should-be-using-cqrs-almost-everywhere/
  - Udi Dahan, 'When to avoid CQRS'. Apr. 22nd, 2011. https://udidahan.com/2011/04/22/when-to-avoid-cqrs/
  - Greg Young, 'CQRS and CAP Theorem'. Feb. 20, 2010. https://web.archive.org/web/20130321023544/http://codebetter.com/gregyoung/2010/02/20/cqrs-and-cap-theorem/
  - Greg Young, 'Versioning in an Event Sourced System'. https://leanpub.com/esversioning/read
  - Greg Young, 'CQRS is not an Architecture'. Sept. 9, 2012. https://web.archive.org/web/20130115130540/http://codebetter.com/gregyoung/2012/09/09/cqrs-is-not-an-architecture-2/
  - Greg Young, 'DDDD 10 [CQS]'. Apr. 28, 2008. https://web.archive.org/web/20130915012037/http://codebetter.com/gregyoung/2008/04/28/dddd-10-cqs/
  - Greg Young, 'DDDD: Master-Detail Question'. Jan. 13, 2009. https://web.archive.org/web/20130915050715/http://codebetter.com/gregyoung/2009/01/13/dddd-master-detail-question/
  - Greg Young, 'CQRS is more work because of the read model?'. Feb. 15, 2010. https://web.archive.org/web/20130321023538/http://codebetter.com/gregyoung/2010/02/15/cqrs-is-more-work-because-of-the-read-model
  ...
  - Mark Murfin, Danil Suits, 'CQRS and the implicit second read model'. 6 Aug, 2016. https://groups.google.com/g/dddcqrs/c/aYrSFFErTM0/m/S_NcczIoAgAJ
  - Milan Jovanović, 'Discovering The Truth About CQRS - No MediatR Required'. https://www.youtube.com/watch?v=F3xNCfP3Xew
  - Vladimir Khorikov, 'CQRS and the CAP Theorem'. Oct 18, 2018. https://www.pluralsight.com/courses/cqrs-in-practice
  - Milan Jovanović, 'EF Core In The CQRS Query Side... Or Something Else?'. 30 May, 2023. https://www.youtube.com/watch?v=RgqCavV2cqQ
  - Milan Jovanović, 'Using Separate Read/Write Models with EF Core and CQRS'. 2 Feb, 2024. https://www.youtube.com/watch?v=iKDITShiZy4
...
- Domain-Driven Design
  ...
  - Mike Mogosanu, 'DDD Decoded - Don't Fear Eventual Consistency'. 23 July, 2016. https://blog.sapiensworks.com/post/2016/07/23/DDD-Eventual-Consistency
  - Mike Mogosanu, 'Why Do We Bother With Eventual Consistency?'. 22 January, 2018. https://blog.sapiensworks.com/post/2018/01/22/Why-do-we-need-eventual-consistency
  - Mike Mogosanu, 'DDD Is Expensive Is A Myth'. 12 May, 2016. https://blog.sapiensworks.com/post/2016/05/12/ddd-is-expensive-myth
  - Mike Mogosanu, 'Domain Driven Design (DDD) Is Not Programming'. 23 November, 2015. https://blog.sapiensworks.com/post/2015/11/23/DDD-is-not-programming
  - Martin Fowler, 'Anemic Domain Model'. 25 November, 2003. https://martinfowler.com/bliki/AnemicDomainModel.html
  - Udi Dahan, 'Employing the Domain Model Pattern' - MSDN Magazine. August 2009. https://learn.microsoft.com/en-us/archive/msdn-magazine/2009/brownfield/employing-the-domain-model-pattern
  - Dino Esposito, 'Reflections on Code First, Persistence and Domain Modeling' - MSDN Magazine. July 2016. https://learn.microsoft.com/en-us/archive/msdn-magazine/2016/july/cutting-edge-reflections-on-code-first-persistence-and-domain-modeling
  - Dino Esposito, 'Design of a Domain Model' - MSDN Magazine. November 2011. https://learn.microsoft.com/en-us/archive/msdn-magazine/2011/november/the-cutting-edge-design-of-a-domain-model
  - Martin Fowler, 'Domain Event'. 12 December, 2005. https://martinfowler.com/eaaDev/DomainEvent.html
  - Dan Haywood, 'An Introduction to Domain Driven Design'. 2009. https://www.methodsandtools.com/archive/archive.php?id=97
  - Greg Young, 'DDD: The Generic Repository'. Jan. 16, 2009. https://web.archive.org/web/20130831053057/http://codebetter.com/gregyoung/2009/01/16/ddd-the-generic-repository/
  - Peter Vogel, 'Simplifying Applications by Implementing Eventual Consistency with Domain Events'. 10/13/2015. https://visualstudiomagazine.com/articles/2015/10/01/implementing-eventual-consistency.aspx
  - Mike Mogosanu, 'Domain Event Design Principles'. 27 March, 2014. https://blog.sapiensworks.com/post/2014/03/27/Domain-Event-Design-Principles.aspx
  - Milan Jovanović, 'How to Use the Domain Event Pattern | DDD, Clean Architecture, .NET 6'. https://www.youtube.com/watch?v=BimfDeDV4yU&t=518s

<br>

- Software & System Architecture
  - 'Stereotypical Architecture'. https://cqrs.wordpress.com/documents/a-stereotypical-architecture/
  - Harris Chandler, 'Microservices vs. monolithic architecture'. https://www.atlassian.com/microservices/microservices-architecture/microservices-vs-monolith
  - Rodolfo Jr. Cerrada, Dmitry Gulin, Tabby Ward, 'Decompose monoliths into microservices by using CQRS and event sourcing'. https://docs.aws.amazon.com/prescriptive-guidance/latest/patterns/decompose-monoliths-into-microservices-by-using-cqrs-and-event-sourcing.html
  - Steve Yonkeu, 'Dissecting layered architecture'. 8 Mar, 2024. https://dev.to/yokwejuste/dissecting-layered-architecture-2ppb
  ...
  - Joseph Ingeno, 'Software Architect's Handbook'. August 2018. ISBN 978-1-78862-406-0
  - Carl Rippon, 'Scalable and Performant ASP.NET Core Web APIs: Introduction'. Jan. 24, 2018. https://www.carlrippon.com/scalable-and-performant-asp-net-core-web-apis-introduction/
  - Jason Taylor, 'Clean Architecture with .NET Core: Getting Started'. Feb. 5, 2020. https://jasontaylor.dev/clean-architecture-getting-started/
...
- Others
  ...
  - Martin Fowler et al., 'Patterns of Enterprise Application Architecture'. Nove 5, 2002. ISBN 978-0-321-12742-6
  - Dino Esposito, 'Queryable Services' - MSDN Magazine. April 2015. https://learn.microsoft.com/en-us/archive/msdn-magazine/2015/april/cutting-edge-queryable-services
  - Microsoft Corp., 'RESTful web API design'. 03/28/2023. https://learn.microsoft.com/en-us/azure/architecture/best-practices/api-design
  - Microsoft Corp., 'Inductive User Interface'. 08/23/2019. https://learn.microsoft.com/en-us/windows/win32/appuistart/inductive-user-interface
  - Steve Smith, 'Architect Modern Web Applications with ASP.NET Core and Azure'. 02/21/2023. https://learn.microsoft.com/en-us/dotnet/architecture/modern-web-apps-azure/
  - Jimmy Bogard, 'You Probably Don't Need to Worry About MediatR'. May 5, 2022. https://www.jimmybogard.com/you-probably-dont-need-to-worry-about-mediatr/
  - Ben Harding, 'A guide to single-page application performance'. Aug 7, 2023. https://raygun.com/blog/spa-performance/
  - Paul Baran, 'Paul Baran and the Origins of the Internet'. https://www.rand.org/about/history/baran.html
  - Greg Young, 'Repository is Dead: Long Live Repository'. Apr. 23, 2009. https://web.archive.org/web/20121112115925/http://codebetter.com/gregyoung/2009/04/23/repository-is-dead-long-live-repository/
...
- Databases related
  - Martin Fowler, 'Reporting Database'. 2 April, 2014. https://martinfowler.com/bliki/ReportingDatabase.html
  - Julian Browne, 'Brewer’s CAP Theorem'. Jan. 11, 2009. http://www.julianbrowne.com/article/viewer/brewers-cap-theorem
  - Adrian K, Cade Roux, Misa J., Corith Malin, 'When to build a separate reporting database?'. Jul 26, 2010. https://stackoverflow.com/questions/3331637/when-to-build-a-separate-reporting-database
  - Oren Eini, 'Document Databases are not Relational'. May 04, 2010. https://ayende.com/blog/4484/document-databases-are-not-relational
